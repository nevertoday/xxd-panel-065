...
# 🦁 XXD Panel 065｜دفتر تحريري بخطين

### استخدم الخطوط الهيكلية السوداء وخطي ألوان الصورة المصدر لإنشاء إيقاع ألوان مرسوم يدويًا
...
يمكن للرسم الخطي العادي أن يوضح الحدود، لكنه غالباً ما يفتقر إلى إيقاع الطباعة. أما تكديس الخطوط الملونة بلا نظام فيتحول بسهولة إلى ظلال مزدوجة فوضوية لا ترتبط ألوانها بالصورة. التحدي الحقيقي هو الحفاظ في آن واحد على البنية والملمس والتوتر الذي تصنعه ألوان محدودة.

يبني **Panel 065** هيكلاً دقيقاً بخطوط سوداء رفيعة، ثم ينتقي من الصورة الأصلية لونين خطيين يصنعان توتراً متبادلاً. تحاكي الإزاحات الطفيفة والتراكب والخطوط المتوازية التسجيل اللوني اليدوي وأخطاء الطباعة القديمة، فتتحول الصورة إلى رسم تحريري خطي منضبط، واضح المعالم، وذو ملمس يدوي صادق.

### استخدمه في هذه الحالات

- **عندما يجب أن تحفظ الخطوط بنية معقدة:** ينبغي أن تكون وضعية الشخص واتجاه العمارة ونسب الأشياء والعلاقات بينها مفهومة من النظرة الأولى.
- **عندما تريد إيقاع التسجيل اللوني لا ظلالاً متعددة الألوان:** تتولى الخطوط السوداء بناء الهيكل، ويصنع لونان مأخوذان من المصدر توتراً دافئاً وبارداً أو فاتحاً وداكناً.
- **عندما تحب عيوب الطباعة القديمة:** يجب أن تبدو الإزاحات وانقطاعات الخطوط والتجاوزات وآثار التصحيح طبيعية ومنضبطة، لا كمؤثر أعطال رقمية.
...
> استخدم XXD Panel 065 لهذه الصورة، واقترح أولاً أنسب تكوين ومقاس.
...
** الكلمات الرئيسية: ** خطوط هيكلية سوداء · خطوط تمييز بلونين · تسجيل ألوان مرسومة يدويًا · خلع الطباعة القديمة · التنضيد الدقيق

يستخدم Panel 065 خطوطًا سوداء رفيعة ومتقطعة مرسومة يدويًا مع آثار تصحيح كالهيكل العظمي، ثم يختار لونين متوترين من الصور لجعل الخطوط الملونة والخطوط السوداء غير محاذية قليلاً أو متداخلة أو متوازية.

<!-- xxd-panel-benefit:start -->
## تحقق سريع: هل XXD Panel 065 مناسب لك؟

| ما الذي يهمك؟ | ما الذي يقدمه هذا الأسلوب؟ |
|---|---|
| **النتيجة التي ستحصل عليها** | استخدم الخطوط الهيكلية السوداء وخطي ألوان الصورة المصدر لإنشاء إيقاع ألوان مرسوم يدويًا |
| **السمات التي تُعرف من النظرة الأولى** | خطوط هيكلية سوداء · خطوط تمييز بلونين · تسجيل ألوان مرسومة يدويًا · خلع الطباعة القديمة · التنضيد الدقيق |
...
يحافظ الرسم الهيكلي الأسود الدقيق على الوضعية والاتجاه والعلاقات، ثم يصبح لونان مصدران مع توتر مفيد خطوط تسجيل. إن المحاذاة غير الصحيحة والتداخل والخطوط المتوازية قليلاً تجعل النتيجة تبدو وكأنها ورقة افتتاحية مقيدة ومطبوعة بشكل حقيقي.

```text
تحديد البنية الرئيسية والوضعية والاتجاه ← تحديد الهيكل العظمي بخط أسود ناعم ← اختيار لونين مصدريين مع توتر بصري ← خطأ في تسجيل الخطوط الملونة أو تداخلها أو موازاتها ← التحكم في الكثافة من خلال المقياس والمساحة ← دمج الطباعة الدقيقة الضيقة
```

## السمات التي تميّز الأسلوب النهائي

- الخط الأسود المرسوم باليد هو الهيكل الهيكلي، مع الاحتفاظ بالتمايل، والتوقف المؤقت، والتجاوز، والفواصل، والتصحيح.
- يأتي خطان مميزان بدقة من المصدر، ويفضل أن يشكلا توترًا دافئًا وباردًا أو غامقًا فاتحًا بدون ألوان إضافية.
- توجد خطوط الألوان خارج السجل قليلاً، أو تتداخل، أو تعمل بجانب اللون الأسود لإنشاء تسجيل يدوي وإيقاع الطباعة القديمة.
- لا يوجد تعبئة ألوان واسعة؛ يخلق الخط والمقياس والاتجاه والمساحة الفارغة الوزن البصري.
- يحمل النوع الدقيق الذي يشبه الحروف المطبوعة أخطاء أساسية طفيفة ويشترك في النقص الصادق في الرسم.

توجد القيود الجمالية وقواعد الرفض فقط في [الموجّه الصيني الأصلي](references/original-prompt/zh-CN.md)، بينما يتولى الـ Skill ومهايئ التشغيل متغيرات التسليم فقط. [سير عمل Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-065-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 065. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-065 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-065 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-065 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-065 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-065 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 065 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-065 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-065`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-065-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-065-prompt.zh-CN.md)
...
| **[xxd-panel-065](https://github.com/nevertoday/xxd-panel-065)** | شكل أسود رئيسي · فراغ هائل · تلاشي هالف تون · تأمل زِنّي · شظايا فكر |
...
| **الجنود** | `xxd-panel-NNN` (حالياً 001–065) | تنفذ كل مهارة مرقمة موجّهها الأصلي وجماليتها الخاصة فقط، وتنجز المهمة الفردية التي يرسلها الجنرال. |
