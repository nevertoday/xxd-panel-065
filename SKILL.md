...
```text
/xxd-panel-065 <source-or-directory> --mode top-bottom,design-only \
...
1. 上下对照（原图在上，065 设计在下）
2. 左右对照（原图在左，065 设计在右）
...
```text
~/Desktop/xxd/xxd-panel-065/<fresh-task>/
...
- `references/xxd-panel-065-prompt.zh-CN.md`
- `references/xxd-panel-065-prompt.en.md`
